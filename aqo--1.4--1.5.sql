...
BEGIN
  ...
  SELECT fspace_hash FROM aqo_queries aq WHERE (aq.queryid = queryid) INTO lfs;
  ...
  DELETE FROM aqo_queries aq WHERE aq.queryid = queryid;
...
BEGIN
  ...
  SELECT fspace_hash FROM aqo_queries aq WHERE aq.queryid = queryid INTO fs;
